...
// HTMLコンテンツを生成する
const htmlContent = `
<!DOCTYPE html><html lang="ja"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>2024 yamanoku's Mastodon Content</title><link rel="stylesheet" href="//cdn.skypack.dev/yama-normalize" /></head><body><main><h1>2024 yamanoku's ActivityPub Contents</h1>${contentArray.join("\n")}</main></body></html>`;
